...
export default function WeatherBox( ) {
    ...
    return (
        <div className="bg-[#DACEE4] w-[40rem] h-96 my-4 mx-4 py-5 px-8 rounded-3xl shadow-md shadow-[#CCDF9F] overflow-hidden">
            ...
            <img src="clockmockup.png" className=' w-96 h-96 ml-[25rem] mt-[-7rem] drop-shadow-[-10.2px_-10.2px_20.2px_#CCDF9F]' style={{ transform: `rotate(${rotationAngle}deg)` }} alt="Clock mockup" />
        </div>
    );
}