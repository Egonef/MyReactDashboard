...
export default function WeatherBox( ) {
    ...
    return (
        <div className="bg-[#DACEE4] w-[40rem] h-96 my-4 mx-4 py-5 px-8 rounded-3xl shadow-md shadow-[#CCDF9F] ">
            ...
            <div className=' h-96 w-96 bg-slate-600 absolute translate-x-96 -translate-y-24 rounded-[20rem]'></div>
        </div>
    );
}